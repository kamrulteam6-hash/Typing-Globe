...
const content: LanguageDeepContent = {
  ...
  researchedKeywords: [
    ...
    "malayalam wpm test",
    "how to type malayalam",
    "malayalam typing test for govt job",
  ],
  blocks: [
    {
      type: "hero",
    ...
    { type: "heading", text: "Malayalam Typing Speed Benchmarks (WPM)", id: "benchmarks" },
    {
      type: "table",
    ...
    { type: "heading", text: "Real Jobs and Exams That Require Malayalam Typing Speed", id: "requirements" },
    {
      type: "table",
    ...
    { type: "heading", text: "Malayalam Around the World", id: "diaspora" },
    {
      type: "table",
    ...
    { type: "heading", text: "Frequently Asked Questions", id: "faq" },
    {
      ...
      items: [
        {
          question: "What typing speed do I need for the Kerala PSC Malayalam test?",
          answer:
        ...
        {
          question: "Do I need a special keyboard to type Malayalam?",
          answer:
        ...
        {
          question: "What's the difference between InScript and phonetic Malayalam typing?",
          answer:
        ...
        {
          question: "Is this Malayalam typing test free?",
    ...
    {
      type: "cta",
      text: "സമയം തിരഞ്ഞെടുത്ത് ടൈപ്പിംഗ് ആരംഭിക്കൂ — നിങ്ങളുടെ WPM ഉടൻ കാണൂ.",
    },
  ],
};
